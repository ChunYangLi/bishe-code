...
//UITableViewDataSource 返回indexPath对应的cell的高度
...
//UIScrollViewDelegate scrollView将要开始滑动
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView {
    [self.headerView removeTimer];
}

//UIScrollViewDelegate scrollView已经停止拖动（手指离开屏幕时调用）
...
//TTImageCyclePlayViewDelegate 点击了轮播图当前播放的imageView
